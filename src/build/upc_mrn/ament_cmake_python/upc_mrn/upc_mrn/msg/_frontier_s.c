...
bool upc_mrn__msg__frontier__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("upc_mrn.msg._frontier.Frontier", full_classname_dest, 30) == 0);
  }
  upc_mrn__msg__Frontier * ros_message = _ros_message;
  {  // size
  ...
  {  // cells_points
    PyObject * field = PyObject_GetAttrString(_pymsg, "cells_points");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'cells_points'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    geometry_msgs__msg__Point * dest = ros_message->cells_points.data;
  ...
  {  // center_cell
    PyObject * field = PyObject_GetAttrString(_pymsg, "center_cell");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->center_cell = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // cells
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint32_t * dest = ros_message->cells.data;
...
{
  /* NOTE(esteve): Call constructor of Frontier */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("upc_mrn.msg._frontier");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Frontier");
  ...
  {  // cells_points
    ...
    for (size_t i = 0; i < size; ++i) {
      item = &(ros_message->cells_points.data[i]);
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "cells_points", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // center_cell
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->center_cell);
    {
      int rc = PyObject_SetAttrString(_pymessage, "center_cell", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // cells
    ...
    if (ros_message->cells.size > 0) {
      ...
      uint32_t * src = &(ros_message->cells.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->cells.size * sizeof(uint32_t));
      assert(data != NULL);
