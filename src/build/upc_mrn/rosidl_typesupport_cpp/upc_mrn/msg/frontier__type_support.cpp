...
static const _Frontier_type_support_symbol_names_t _Frontier_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, upc_mrn, msg, Frontier)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, upc_mrn, msg, Frontier)),
  }
};
...
{
  return &::upc_mrn::msg::rosidl_typesupport_cpp::Frontier_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, upc_mrn, msg, Frontier)() {
  return get_message_type_support_handle<upc_mrn::msg::Frontier>();
}
